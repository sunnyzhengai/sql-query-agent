...
It NEVER generates — run 610_generate_agent_descriptions first.
"""
...
require_engine(src.__version__, REQUIRES_ENGINE, "900_publish_collibra")
...
if not spark.catalog.tableExists("ops_agent_descriptions"):
    raise SystemExit(
        "ops_agent_descriptions is missing — run 610_generate_agent_descriptions "
...
if not desc_lookup:
    raise SystemExit("No publishable descriptions — run 610 first.")
...
if match_result.unmatched_objects:
    ...
    _rows = [(_now, "900_match", name, "no_collibra_match",
