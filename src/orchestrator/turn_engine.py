...
SYSTEM_PROMPT = (
    ...
    "3b. Requests for patient-level data, row counts, or individual "
    "records: refuse in your FIRST reply with exactly this sentence: "
    f"'{product_name()} answers definitions, not data — patient rows "
    "never reach the model.' Then offer the certified definition and "
    "where it runs. Never spend tool rounds attempting such "
    "requests.\n"
