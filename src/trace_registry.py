...
TRACE_REGISTRY = {
    ...
    "0081": {
        ...
        "component": "architecture",
        "axioms": [],
        "modules": ["aisql/flows/censuses.py", "aisql/flows/connect.py"],
        "tests": ["tests/aisql/test_connection_census.py"],
    ...
    "0080": {
        ...
        "component": "architecture",
        "axioms": [],
        "modules": ["aisql/flows/grounding.py", "aisql/flows/ask.py"],
        "tests": ["tests/aisql/test_ask_console.py"],
        "docs": ["docs/decisions/"
    ...
    "0079": {
        ...
        "component": "architecture",
        "axioms": [],
        "modules": ["aisql/flows/ask.py", "aisql/console.py"],
        "tests": ["tests/aisql/test_ask_console.py"],
        "docs": ["docs/decisions/"
    ...
    "0078": {
        ...
        "component": "architecture",
        "axioms": [],
        "modules": ["aisql/lenses/ask_index.py", "aisql/flows/ask.py",
                    "aisql/console.py"],
        "tests": ["tests/aisql/test_ask_console.py"],
    ...
    "0077": {
        ...
        "component": "spec",
        "axioms": [],
        "modules": ["aisql/graph/kg2_mapper/__init__.py",
                    "aisql/graph/metamodel.py",
                    "AIVIA_Design/registries/convert_from_xlsx.py"],
        "tests": ["tests/aisql/test_phase_a_projection.py",
