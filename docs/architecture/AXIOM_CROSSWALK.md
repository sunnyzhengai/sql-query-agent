...
| spec:G5 | structure carried, never lowered | axm:D2 | the same parent as G2 — both are the founder's sanctioned-powers doctrine applied to representation: meaning lives in structure, and discarding structure is an unsanctioned lowering | 0076 |
