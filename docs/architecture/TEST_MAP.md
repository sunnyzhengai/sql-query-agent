...
154 modules, 1712 tests, every module accounted: claimed by an ADR in the trace registry or declaring a law/contract in its docstring (`Proves:` line).
...
| 0078 | The ask-the-graph console: free questions, typed paths, self-answering nodes | `tests/aivia/test_ask_console.py` (14) |
| 0079 | The interpreter and the speaking graph | `tests/aivia/test_ask_console.py` (14) |
...
- `tests/aivia/test_ask_console.py` (14): ADR 0078 exit: the F9 ask-console answer keys go RUNNABLE.
