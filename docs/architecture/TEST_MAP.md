...
154 modules, 1713 tests, every module accounted: claimed by an ADR in the trace registry or declaring a law/contract in its docstring (`Proves:` line).
...
| 0078 | The ask-the-graph console: free questions, typed paths, self-answering nodes | `tests/aivia/test_ask_console.py` (15) |
| 0079 | The interpreter and the speaking graph | `tests/aivia/test_ask_console.py` (15) |
...
- `tests/aivia/test_ask_console.py` (15): Tier A exit (ADR 0079): the F10 answer keys go RUNNABLE.
