...
108 modules, 1110 tests, every module accounted: claimed by an ADR in the trace registry or declaring a law/contract in its docstring (`Proves:` line).
...
| 0037 | The completed algebra: traverse + result-set kernels | `tests/graph/test_traversal.py` (2), `tests/orchestrator/test_ops.py` (69) |
...
| 0043 | The diff kernel: the founding question's shape | `tests/graph/test_decomposition_diff.py` (11), `tests/orchestrator/test_ops.py` (69) |
...
| 0053 | Projection-grain column lineage: transform_to_column edges, resolved-only, conservation-counted | `tests/graph/test_builder.py` (16), `tests/orchestrator/test_ops.py` (69) |
...
- `tests/orchestrator/test_sameness.py` (16): Walk W6/W7 (Sunny live, 2026-08-23): sameness honesty. The corpse:
- `tests/orchestrator/test_walk_continuation.py` (17): Walk 1562 continuation (steps 3–6, 2026-08-23) — L0 for the P0/P1
...
- `tests/test_endpoint_hygiene.py` (2): Endpoint hygiene — no tenant endpoint ever lives in this repo.
