...
118 modules, 1327 tests, every module accounted: claimed by an ADR in the trace registry or declaring a law/contract in its docstring (`Proves:` line).
...
| 0035 | Agentic conversation over deterministic tools | `tests/orchestrator/test_agent.py` (6), `tests/orchestrator/test_tools.py` (21), `tests/webapp/test_app.py` (76) |
| 0036 | Operations are the product: plan, confirm, execute, display | `tests/orchestrator/test_caption_gate.py` (33), `tests/orchestrator/test_conclusion.py` (28), `tests/test_methodology.py` (8) |
...
| 0062 | The dialogue loop: show, propose, ask, execute | `tests/webapp/test_app.py` (76) |
...
- `tests/orchestrator/test_conclusion.py` (28): The Answer Format Contract's composer (RW-10): card class is
