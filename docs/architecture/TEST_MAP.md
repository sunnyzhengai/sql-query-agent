...
| spec:B2 | 0044, 0074 | `tests/test_desc_0074.py`, `tests/test_skeleton_composer.py` | `tests/graph/test_decision_wiring.py`, `tests/test_tree_contract.py`, `tests/tree/test_extract.py` |
...
| spec:F | 0044, 0074 | — | `tests/graph/test_decision_wiring.py`, `tests/test_desc_0074.py`, `tests/test_skeleton_composer.py`, `tests/test_tree_contract.py`, `tests/tree/test_extract.py` |
...
| spec:T1 | 0065, 0074 | — | `tests/test_desc_0074.py`, `tests/test_skeleton_composer.py`, `tests/test_tree_contract.py` |
