...
154 modules, 1711 tests, every module accounted: claimed by an ADR in the trace registry or declaring a law/contract in its docstring (`Proves:` line).
...
| 0078 | The ask-the-graph console: free questions, typed paths, self-answering nodes | `tests/aivia/test_ask_console.py` (13) |
...
- `tests/aivia/test_ask_console.py` (13): ADR 0078 exit: the F9 ask-console answer keys go RUNNABLE.
