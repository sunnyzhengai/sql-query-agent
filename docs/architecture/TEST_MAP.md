...
113 modules, 1212 tests, every module accounted: claimed by an ADR in the trace registry or declaring a law/contract in its docstring (`Proves:` line).
...
| 0036 | Operations are the product: plan, confirm, execute, display | `tests/orchestrator/test_caption_gate.py` (30), `tests/orchestrator/test_conclusion.py` (15), `tests/test_methodology.py` (8) |
