# Gap-check report — floors under grammar 2.1.0
...
- The medication id is one of the values defined by another selection.
...
- It is not the case that the time designated by the user when the action occurred has no recorded value.
- The mar_action_category_number linked is one of the values defined by another selection.
- It is not the case that the method by which is one of the values defined by another selection.
```
...
- The date presented in standard date format is cast(mar.taken_time as date).
- It is not the case that the time designated by the user when the action occurred has no recorded value.
- The unique identifier for the medication record linked is one of the values defined by another selection or .
- The mar_action_category_number linked is one of the values defined by another selection.
...
- The unique identifier for the base grouper record is vcg-.1 is one of the values defined by another selection.
- The mar_action_category_number linked is one of the values defined by another selection.
...
- The unique identifier for each result component associated with every result is one of the values defined by another selection.
```
...
- The unique identifier for the procedure record associated is one of the values defined by another selection.
- The date presented in standard date format is cast(po.order_time as date).
```
...
This is a selection of records.
Drawn from the base pop selection defined earlier in this procedure, restricted to records also present in flowsheet records records, restricted to records also present in flowsheet measurements records.
- The unique identifier for the flowsheet group or row linked is one of the values defined by another selection.
...
- The mar_action_category_number linked is one of the values '1' (noted 'GIVEN'), '7' (noted 'RESTARTED'), '102' (noted 'GIVEN BY OTHER'), '105' (noted 'NEW CARTRIDGE'), '113' (noted 'GIVEN DURING DOWNTIME'), '114' (noted 'STARTED DURING DOWNTIME'), '115' (noted 'MEDICATION APPLIED'), '122' (noted 'CONTINUED FROM OR'), '124' (noted 'SELF ADMINISTERED VIA PUMP'), '132' (noted 'CONTINUED FROM PREVIOUS ORDER'), '143' (noted 'REDOSE'), '1604' (noted 'INFUSION GREATER THAN 15 MIN'), '1605' (noted 'INFUSION LESS THAN 15 MIN'), '1607' (noted 'NEW CARTRIDGE'), '6' (noted 'NEW BAG'), '99' (noted 'RATE CHANGE').
- The unique identifier for the medication record linked is one of the values defined by another selection.
The second alternative:
Drawn from the base pop selection defined earlier in this procedure, restricted to records also present in medication orders records, restricted to records also present in medications records, restricted to records also present in med admin records records.
