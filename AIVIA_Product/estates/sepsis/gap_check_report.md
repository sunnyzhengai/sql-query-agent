...
*Generated by the engine over the anonymized sepsis estate,
2026-09-06. Sunny: every floor below is a machine claim about
logic you know cold — mark anything that says an untrue thing.*
...
[extract: emr] loaded 90 tables, 4138 columns; checks: pass
  counted missing: 90 table(s) with no declared grain (emr|dbo|ADT_EVENTS, emr|dbo|ALERT_ACTIONS, emr|dbo|ALERT_HISTORY, emr|dbo|BED_CONFIG, emr|dbo|CALENDAR_DATES, emr|dbo|CLINICAL_ALERTS, emr|dbo|CLINICAL_NOTES, emr|dbo|CONFIG_GROUPER_CATEGORIES, emr|dbo|CONFIG_VALUE_SET, emr|dbo|DEPARTMENTS, emr|dbo|DIAGNOSES, emr|dbo|ED_ENCOUNTERS_DM, emr|dbo|ED_ENCOUNTERS_FACT, emr|dbo|ED_EVENT_INFO, emr|dbo|ED_EVENT_TEMPLATES, emr|dbo|ED_PATIENT_INFO, emr|dbo|EMPLOYEES, emr|dbo|ENCOUNTER_DIAGNOSES, emr|dbo|ENCOUNTER_VISIT_REASONS, emr|dbo|FLOWSHEET_MEASUREMENTS, emr|dbo|FLOWSHEET_RECORDS, emr|dbo|FY_DATE_DIMENSION, emr|dbo|GROUPER_COMPILED_LIST, emr|dbo|GROUPER_GROUPS, emr|dbo|GROUPER_MED_RECORDS, emr|dbo|GROUPER_TERMINOLOGY, emr|dbo|HOSPITAL_ACCOUNTS, emr|dbo|HOSPITAL_ACCOUNTS_EXT, emr|dbo|HOSPITAL_ACCT_DIAGNOSES, emr|dbo|HOSPITAL_ENCOUNTERS, emr|dbo|HOSPITAL_TRANSACTIONS, emr|dbo|IP_SEPSIS, emr|dbo|IP_SepsisDetails, emr|dbo|IP_SepsisEncounters, emr|dbo|IP_SepsisEncountersWLocations, emr|dbo|IP_SepsisPatientDates, emr|dbo|IP_SepsisScreeningAudit, emr|dbo|IP_SepsisShiftCompliance, emr|dbo|LAB_COMPONENTS, emr|dbo|LAB_ORDER_RESULTS, emr|dbo|LINE_DEVICE_AIRWAY, emr|dbo|LOCATIONS, emr|dbo|MEDICATIONS, emr|dbo|MEDICATION_ORDERS, emr|dbo|MEDICATION_ORDERS_EXT, emr|dbo|MED_ADMIN_RECORDS, emr|dbo|MED_DETAILS_EXT, emr|dbo|MED_MIX_COMPONENTS, emr|dbo|NON_SEVERE_SEPSIS_STAGING, emr|dbo|NOTE_ENCOUNTER_INFO, emr|dbo|NOTE_TEMPLATE_LIST_IDS, emr|dbo|NOTE_TEMPLATE_TEXT_IDS, emr|dbo|ORDER_DISPENSE_INFO, emr|dbo|ORDER_TRACKING_METRICS, emr|dbo|ORGANISMS, emr|dbo|PATIENTS, emr|dbo|PATIENT_DEMOGRAPHICS_RACE, emr|dbo|PATIENT_ENCOUNTERS, emr|dbo|PROCEDURES_CATALOG, emr|dbo|PROCEDURE_ORDERS, emr|dbo|PROCEDURE_ORDERS_EXT, emr|dbo|PROVIDERS, emr|dbo|REF_ALERT_ACTIONS, emr|dbo|REF_ALERT_OVERRIDE_REASONS, emr|dbo|REF_ALERT_STATUS, emr|dbo|REF_DISCHARGE_DISPOSITION, emr|dbo|REF_ED_DISPOSITION, emr|dbo|REF_ETHNIC_GROUP, emr|dbo|REF_GENERIC_MED, emr|dbo|REF_PATIENT_CLASS, emr|dbo|REF_PATIENT_RACE, emr|dbo|REF_SEX, emr|dbo|REF_SHOWN_PLACE, emr|dbo|RX_VERIFY_TRACE, emr|dbo|SEVERE_SEPSIS_STAGING, emr|dbo|TREATMENT_TEAMS, emr|dbo|VISIT_REASONS, emr|dbo|V_HOSPITAL_TRANSACTIONS, emr|dbo|V_PATIENT_ENCOUNTERS, emr|dbo|V_PATIENT_LOCATION_HISTORY, emr|dbo|V_PHARMACY_DISPENSE, emr|dbo|V_PHARMACY_DISPENSE_ACTION, emr|dbo|V_PHARMACY_ORDER, emr|dbo|CLINICAL_NOTE_TEXT, emr|dbo|DIAGNOSES_CURRENT_ICD10, emr|dbo|HOSPITAL_ACCT_PX_LIST, emr|dbo|ICD_PROCEDURE_CODES, emr|dbo|PATIENT_OR_ADM_LINK, emr|dbo|V_OR_CASE_LOG, emr|dbo|ICU_STAY_SUMMARY)
  pending reference: fk group 52 -> emr|dbo|IP_SEPSISENCOUNTERSWLOCATIONS (target not yet registered; resolves on arrival, A8)
  pending reference: fk group 53 -> emr|dbo|IP_SEPSISPATIENTDATES (target not yet registered; resolves on arrival, A8)
...
[estate] acquired 28 file(s): reporting/USP_ED_SEPSIS.sql, reporting/USP_IP_SEPSIS.sql, reporting/USP_IP_SepsisDates.sql, reporting/USP_IP_SepsisDetails.sql, reporting/USP_IP_SepsisDetails_v1.sql, reporting/USP_IP_SepsisEncounters.sql, reporting/USP_IP_SepsisEncountersDetails.sql, reporting/USP_IP_SepsisEncountersWLocations.sql, reporting/USP_IP_SepsisEncountersWLocations_v1.sql, reporting/USP_IP_SepsisPatientDates.sql, reporting/USP_IP_SepsisPatientDates_v1.sql, reporting/USP_IP_SepsisScreeningAudit.sql, reporting/USP_IP_SepsisScreeningAudit_v1.sql, reporting/USP_IP_SepsisShiftCompliance.sql, reporting/USP_IP_SepsisShiftComplianceByShift.sql, reporting/USP_IP_SepsisShiftComplianceMetrics.sql, reporting/USP_IP_Sepsis_ComplianceByShift.sql, reporting/USP_IP_Sepsis_ComplianceMetrics.sql, reporting/USP_IP_Sepsis_Details.sql, reporting/USP_IP_Sepsis_Encounters.sql, reporting/USP_IP_Sepsis_ScreeningTool.sql, reports/USP_RPTS_ED_Sepsis.sql, reports/USP_RPTS_IP_SEPSIS.sql, reports/USP_RPTS_IP_SEPSIS_COMPLIANCE.sql, reports/USP_RPTS_IP_SEPSIS_COMPLIANCE_BY_SHIFT_NURSES.sql, reports/USP_RPTS_IP_SEPSIS_REPORT.sql, reports/USP_RPTS_NonSevere_Sepsis.sql, reports/USP_RPTS_Severe_Sepsis.sql
  unresolved reference: reports.CONFIG_VALUE_SET in reporting/USP_ED_SEPSIS.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reports.SEVERE_SEPSIS_STAGING in reporting/USP_ED_SEPSIS.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reports.NON_SEVERE_SEPSIS_STAGING in reporting/USP_ED_SEPSIS.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reports.CONFIG_VALUE_SET in reporting/USP_IP_SEPSIS.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reports.CONFIG_VALUE_SET in reporting/USP_IP_SEPSIS.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reports.FY_DATE_DIMENSION in reporting/USP_IP_SepsisDates.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SepsisEncounters in reporting/USP_IP_SepsisDetails.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SepsisPatientDates in reporting/USP_IP_SepsisDetails.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SepsisEncounters in reporting/USP_IP_SepsisDetails.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SepsisDetails in reporting/USP_IP_SepsisDetails_v1.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SepsisEncounters in reporting/USP_IP_SepsisEncountersDetails.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SepsisEncounters in reporting/USP_IP_SepsisEncountersWLocations.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reports.CONFIG_VALUE_SET in reporting/USP_IP_SepsisEncountersWLocations.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SepsisEncounters in reporting/USP_IP_SepsisEncountersWLocations_v1.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SepsisEncountersWLocations in reporting/USP_IP_SepsisEncountersWLocations_v1.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SepsisEncounters in reporting/USP_IP_SepsisPatientDates.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SepsisEncountersWLocations in reporting/USP_IP_SepsisPatientDates.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reports.CONFIG_VALUE_SET in reporting/USP_IP_SepsisPatientDates.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SepsisPatientDates in reporting/USP_IP_SepsisPatientDates_v1.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SepsisEncounters in reporting/USP_IP_SepsisScreeningAudit.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SepsisEncountersWLocations in reporting/USP_IP_SepsisScreeningAudit.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SepsisScreeningAudit in reporting/USP_IP_SepsisScreeningAudit_v1.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SepsisEncounters in reporting/USP_IP_SepsisShiftCompliance.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SepsisEncountersWLocations in reporting/USP_IP_SepsisShiftCompliance.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reports.CONFIG_VALUE_SET in reporting/USP_IP_SepsisShiftCompliance.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SepsisShiftCompliance in reporting/USP_IP_SepsisShiftComplianceByShift.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SepsisShiftCompliance in reporting/USP_IP_SepsisShiftComplianceMetrics.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SEPSIS in reporting/USP_IP_Sepsis_ComplianceByShift.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SEPSIS in reporting/USP_IP_Sepsis_ComplianceMetrics.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SEPSIS in reporting/USP_IP_Sepsis_Details.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SEPSIS in reporting/USP_IP_Sepsis_Encounters.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reporting.IP_SEPSIS in reporting/USP_IP_Sepsis_ScreeningTool.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reports.CONFIG_VALUE_SET in reports/USP_RPTS_ED_Sepsis.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reports.CONFIG_VALUE_SET in reports/USP_RPTS_IP_SEPSIS.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reports.CONFIG_VALUE_SET in reports/USP_RPTS_IP_SEPSIS.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reports.SEVERE_SEPSIS_STAGING in reports/USP_RPTS_IP_SEPSIS.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reports.CONFIG_VALUE_SET in reports/USP_RPTS_IP_SEPSIS_REPORT.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reports.CONFIG_VALUE_SET in reports/USP_RPTS_IP_SEPSIS_REPORT.sql — not in the dictionary (counted, never guessed)
  unresolved reference: reports.SEVERE_SEPSIS_STAGING in reports/USP_RPTS_IP_SEPSIS_REPORT.sql — not in the dictionary (counted, never guessed)
```
...
## Findings
- join compliance: 7 violations, 198 compliant, 469 not judged (caveat: declared joins are lineage-derived — near-vacuous by construction, see pack notes)
- unresolved refs (39): reports.CONFIG_VALUE_SET x11, reporting.IP_SepsisEncounters x8, reporting.IP_SEPSIS x5, reporting.IP_SepsisEncountersWLocations x4, reports.SEVERE_SEPSIS_STAGING x3, reporting.IP_SepsisPatientDates x2, reporting.IP_SepsisShiftCompliance x2, reports.NON_SEVERE_SEPSIS_STAGING x1, reports.FY_DATE_DIMENSION x1, reporting.IP_SepsisDetails x1
- degenerate predicates: 24
- working set: 52 of 90 dictionary tables touched
- descriptions produced: 303 scopes, all skeleton_floor (no smoothing model in the loop — the floor IS the output)
