...
objects into input_sql_sources. Manual file upload (100_install) remains
...
and changed objects are re-loaded. 100_install verifies state after.
"""
...
require_engine(src.__version__, REQUIRES_ENGINE, "030_ingest_sql_live")
...
if config.extractor is None:
    raise ValueError(
        ...
        "Extraction'), or load SQL files manually via 100_install."
    )
...
print("\nNext: run 100_install (first install) or 200_parse onward (refresh).")
