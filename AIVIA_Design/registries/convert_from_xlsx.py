...
TWIN_SHEETS = {
    ...
    "lenses": {
        "Speech_Sources": [
            ...
            {"Label": "table", "Speech": "KG1 steward description",
             "Meaning": "declared truth, as loaded"},
            {"Label": "column", "Speech": "KG1 steward description",
             "Meaning": "declared truth, as loaded"},
            ...
            {"Label": "_self file", "Speech": "a sql file: a stored "
            ...
            {"Label": "_self table", "Speech": "a database table "
            ...
            {"Label": "_self derived column", "Speech": "a computed "
             "or derived output column of a selection",
             "Meaning": "self-description"},
            {"Label": "_self term", "Speech": "a governed business "
            ...
            {"Label": "_self drift", "Speech": "a drift finding: a "
        ...
        "Shape_Ledger": [
            {"Kind": "_ruling", "Name": "-", "Status": "-",
             ...
             "Notes": "THE SHAPE CONTRACT (Sunny, 2026-09-09): the "
             "store's shape IS design. Every label and edge is "
             "declared here with PRESENT or TARGET(landing step); "
             "the shape census (battery #13, Q1/Q2/Q3) FAILS on any "
             "divergence in either direction. Silent divergence — "
             "the blob corpse — is structurally impossible."},
            ...
            {"Kind": "node", "Name": "table", "Status": "PRESENT",
             ...
             "Notes": "dictionary-loaded (§3c)"},
            {"Kind": "node", "Name": "column", "Status": "PRESENT",
             "Description obligation": "stored — counted-gap allowed",
            ...
            {"Kind": "node", "Name": "term", "Status": "PRESENT",
             ...
             "Notes": "kg3; count may be 0 pre-confirmations"},
            {"Kind": "node", "Name": "usage", "Status": "PRESENT",
             "Description obligation": "none-ruled",
             "Notes": "kg3 events; count may be 0 on a fresh boot"},
            {"Kind": "node", "Name": "acronym", "Status": "PRESENT",
             "Description obligation": "expansions (the ruled shape)",
             "Notes": "journal-replayed; count may be 0 without the "
             "journal"},
            {"Kind": "node", "Name": "person", "Status": "PRESENT",
             "Description obligation": "none-ruled",
             "Notes": "minted on first act; may be 0"},
            {"Kind": "node", "Name": "agent", "Status": "PRESENT",
             "Description obligation": "none-ruled", "Notes": ""},
            {"Kind": "node", "Name": "role", "Status": "PRESENT",
             "Description obligation": "none-ruled", "Notes": ""},
            {"Kind": "node", "Name": "responsibility",
             "Status": "PRESENT",
             "Description obligation": "none-ruled", "Notes": "kg3"},
            {"Kind": "node", "Name": "disposition", "Status": "PRESENT",
             "Description obligation": "none-ruled",
             "Notes": "kg3; may be 0"},
            ...
            {"Kind": "edge", "Name": "defines", "Status": "PRESENT",
             "Description obligation": "-", "Notes": ""},
            {"Kind": "edge", "Name": "belongs_to", "Status": "PRESENT",
             "Description obligation": "-", "Notes": ""},
            {"Kind": "edge", "Name": "sighted", "Status": "PRESENT",
             "Description obligation": "-", "Notes": ""},
            {"Kind": "edge", "Name": "translates", "Status": "PRESENT",
             "Description obligation": "-", "Notes": "file↔twin"},
            {"Kind": "edge", "Name": "executes", "Status": "PRESENT",
             "Description obligation": "-", "Notes": "report→proc"},
            {"Kind": "edge", "Name": "describes", "Status": "PRESENT",
             "Description obligation": "-",
            ...
            {"Kind": "edge", "Name": "approved_by", "Status": "PRESENT",
             "Description obligation": "-",
             "Notes": "acronym→person; may be 0 without journal"},
            {"Kind": "edge", "Name": "used_by", "Status": "PRESENT",
             "Description obligation": "-",
        ...
        "Kind_Vocabulary": [
            {"Word": "_superseded", "Label": "-", "Note": "TABLE "
...
def convert():
    ...
    for name, (xlsx, doc_section) in SOURCES.items():
        ...
        if name == "kg1_technical":
            ...
            for row in sheets.get("Node_Types", []):
                if "Node kind" in row:
                    row["Node label"] = row.pop("Node kind")
