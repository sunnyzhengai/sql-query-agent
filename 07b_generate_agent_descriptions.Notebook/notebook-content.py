...
ops_agent_descriptions; 08 (Collibra) and 13 (PBI) are pure publishers
that consume it. Run AFTER 04 (needs output_metric_logic hashes);
...
require_engine(src.__version__, REQUIRES_ENGINE, "07b_generate_agent_descriptions")
...
precondition_gate("07b_generate_agent_descriptions",
...
# output_metric_logic is a REQUIRED input (04 writes it; the gate above
...
print("Next: 08_publish_collibra and/or 13_publish_pbi consume this table.")
