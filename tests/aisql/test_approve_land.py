...
from aisql.flows import approve, inbound, land, materialize, produce
from aisql.graph import kg1_intake, kg3_artifacts
...
def test_render_native_columns_only_with_prefix(approved):
    ...
    assert payload["Description"].startswith("AISQL agent generated: ")
